...
HD_PWD='D:/INIGO/AP_CONTEST/PROJECTS_VIVADO/berry_09_05_2018/berry_design/berry_design.runs/design_1_fifo_dma_synchro_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fifo_dma_synchro_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fifo_dma_synchro_0_0.tcl
