...
HD_PWD='D:/INIGO/AP_CONTEST/PROJECTS_VIVADO/berry_09_05_2018/berry_design/berry_design.runs/design_1_first_demux_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_first_demux_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_first_demux_0_1.tcl
